...
#define SEG3_GPU_DVFS_FREQ0			(850000)	/* KHz */
#define SEG3_GPU_DVFS_FREQ1			(800000)	/* KHz */
#define SEG3_GPU_DVFS_FREQ2			(750000)	/* KHz */
#define SEG3_GPU_DVFS_FREQ3			(700000)	/* KHz */
#define SEG3_GPU_DVFS_FREQ4			(650000)	/* KHz */
#define SEG3_GPU_DVFS_FREQ5			(600000)	/* KHz */
#define SEG3_GPU_DVFS_FREQ6			(550000)	/* KHz */
#define SEG3_GPU_DVFS_FREQ7			(500000)	/* KHz */
#define SEG3_GPU_DVFS_FREQ8			(450000)	/* KHz */
#define SEG3_GPU_DVFS_FREQ9			(400000)	/* KHz */

#define SEG3_GPU_DVFS_VOLT0			(87500)		/* mV x 100 */
#define SEG3_GPU_DVFS_VOLT1			(85000)		/* mV x 100 */
#define SEG3_GPU_DVFS_VOLT2			(82500)		/* mV x 100 */
#define SEG3_GPU_DVFS_VOLT3			(80000)		/* mV x 100 */
#define SEG3_GPU_DVFS_VOLT4			(77500)		/* mV x 100 */
#define SEG3_GPU_DVFS_VOLT5			(75000)		/* mV x 100 */
#define SEG3_GPU_DVFS_VOLT6			(72500)		/* mV x 100 */
#define SEG3_GPU_DVFS_VOLT7			(70000)		/* mV x 100 */
#define SEG3_GPU_DVFS_VOLT8			(67500)		/* mV x 100 */
#define SEG3_GPU_DVFS_VOLT9			(65000)		/* mV x 100 */
...
#define SEG3_GPU_DVFS_VSRAM8			(87500)		/* mV x 100 */
#define SEG3_GPU_DVFS_VSRAM9			(87500)		/* mV x 100 */
